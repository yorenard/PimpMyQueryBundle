...
use YoRenard\PimpMyQueryBundle\EventListener\Subscriber\CustomParamSubscriber;
...
class CustomParamType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->addEventSubscriber(new CustomParamSubscriber());
        ;
    }
    ...
    {
        return array (
            'data_class' => 'YoRenard\PimpMyQueryBundle\Entity\CustomParam',
